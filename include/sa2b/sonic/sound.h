...
EXTERN_START
void    SE_Call(   int32_t se, const void* pTask,                         int8_t pri, int8_t volume );
void    SE_CallV2( int32_t se, const void* pTask, const NJS_POINT3* pPos, int8_t pri, int8_t volume );
...
void    SE_Call_Timer(   int32_t se, const void* pTask,                         int8_t pri, int8_t volume, int16_t timer );
void    SE_CallV2_Timer( int32_t se, const void* pTask, const NJS_POINT3* pPos, int8_t pri, int8_t volume, int16_t timer );

void    SE_Call_Loop(   int32_t se, const void* pTask,                         int8_t volume );
void    SE_CallV2_Loop( int32_t se, const void* pTask, const NJS_POINT3* pPos, int8_t volume );
...
void    SE_Add_Volume( int32_t se, const void* pTask, int8_t  volume );
void    SE_Add_Pitch(  int32_t se, const void* pTask, int16_t pitch  );
void    SE_Add_Pan(    int32_t se, const void* pTask, int8_t  pan    );

/** Only bosses call these, their exact function isn't fully understood yet. Perhaps, 
    'SC' stands for SpeCial? **/

void    SE_Call_SCLoop(const void* pTask, uint16_t flags);
void    SE_CallV2_SCLoop(int32_t se, const void* pTask, const NJS_POINT3* pPos, int8_t pri, int8_t volume, int16_t timer);
