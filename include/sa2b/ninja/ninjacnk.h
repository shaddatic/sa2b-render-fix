...
typedef    struct    {
    ...
    float32    sx;                /* Screen X         04:08*/
    float32    sy;                /* Screen Y         08:12*/
    float32    ooz;               /* One over Z       12:16*/
    ...
    union  {                    /*                  48:56*/
        ...
        float32    inten[2];      /* intensity        48:56*/
    } col;                      /* color            48:56*/
...
typedef    struct    {
    float32    x;                /* Screen X                */
    float32    y;                /* Screen Y                */
    float32    ooz;              /* One over Z              */
    float32    inten;            /* intensity               */
} NJS_CNK_EASY_BUF;
