...
#define __control_3d_flag_      DataRef(uint32, 0x01DEB6A4)
#define __constant_attr_and_    DataRef(uint32, 0x01DEB6A8)
#define __constant_attr_or_     DataRef(uint32, 0x01DEB6A0)
