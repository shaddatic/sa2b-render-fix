...
TaskFuncPtr(ALO_ObakeHeadExecutor, 0x54A050);
TaskFuncPtr(ALO_ObakeHeadDisplayer, 0x54A0F0);

FuncPtr(task*, __cdecl, ALO_ObakeHeadCreate, (eHEAD_PARTS kind, NJS_POINT3* pPos, Angle AngY, NJS_VECTOR* pVelo, ITEM_SAVE_INFO* pSaveInfo), 0x54A540);