...
enum DWRITE_INFORMATIONAL_STRING_ID
{
    ...
    /// <summary>
    /// Description of how the font may be legally used, or different example scenarios for licensed use. This field should be written in basic language, not legalese.
    /// </summary>
...
interface DWRITE_DECLARE_INTERFACE("08256209-099a-4b34-b86d-c22b110e7771") IDWriteLocalizedStrings : public IUnknown
{
    ...
    STDMETHOD(GetLocaleName)(
        UINT32 index,
        __out_ecount_z(elemsize) WCHAR* localeName,
        UINT32 elemsize
        ) PURE;
    ...
    STDMETHOD(GetString)(
        UINT32 index,
        __out_ecount_z(elemsize) WCHAR* stringBuffer,
        UINT32 elemsize
        ) PURE;
};
