...
{
    XMVECTOR R = XMVectorReplicate(t);
    return XMQuaternionSlerpV(Q0, Q1, R);
}
...
)
{
    ...
    XMASSERT((XMVectorGetY(R) == XMVectorGetX(R)) && (XMVectorGetZ(R) == XMVectorGetX(R)) && (XMVectorGetW(R) == XMVectorGetX(R)));
    ...
    V01 = _mm_shuffle_ps(R,R,_MM_SHUFFLE(2,3,0,1));
...
{
    XMVECTOR R = XMVectorReplicate(t);
    return XMQuaternionSquadV(Q0, Q1, Q2, Q3, R);
}
...
)
{
    ...
    Q03 = XMQuaternionSlerpV(Q0, Q3, R);
    Q12 = XMQuaternionSlerpV(Q1, Q2, R);
...
)
{
    ...
    *pLinePoint2 = XMVectorSelect(LinePoint2,g_XMQNaN.v, Control);
    ...
    LinePoint2 = _mm_add_ps(LinePoint1, V);
