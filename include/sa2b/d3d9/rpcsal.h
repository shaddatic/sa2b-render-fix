...
#define __RPC__in_ecount(elemsize) 
#define __RPC__in_ecount_full(elemsize)
#define __RPC__in_ecount_full_string(elemsize)
#define __RPC__in_ecount_part(elemsize, length)
#define __RPC__in_ecount_full_opt(elemsize)
#define __RPC__in_ecount_full_opt_string(elemsize)
#define __RPC__inout_ecount_full_opt_string(elemsize)
#define __RPC__in_ecount_part_opt(elemsize, length)
#define __RPC__in_xcount(elemsize) 
#define __RPC__in_xcount_full(elemsize)
#define __RPC__in_xcount_full_string(elemsize)
#define __RPC__in_xcount_part(elemsize, length)
#define __RPC__in_xcount_full_opt(elemsize)
#define __RPC__in_xcount_full_opt_string(elemsize)
#define __RPC__inout_xcount_full_opt_string(elemsize)
#define __RPC__in_xcount_part_opt(elemsize, length)
...
#define __RPC__deref_in_ecount(elemsize) 
#define __RPC__deref_in_ecount_part(elemsize, length) 
#define __RPC__deref_in_ecount_full(elemsize) 
#define __RPC__deref_in_ecount_full_opt(elemsize)
#define __RPC__deref_in_ecount_full_string(elemsize)
#define __RPC__deref_in_ecount_full_opt_string(elemsize)
#define __RPC__deref_in_ecount_opt(elemsize) 
#define __RPC__deref_in_ecount_opt_string(elemsize)
#define __RPC__deref_in_ecount_part_opt(elemsize, length) 
#define __RPC__deref_in_xcount(elemsize) 
#define __RPC__deref_in_xcount_part(elemsize, length) 
#define __RPC__deref_in_xcount_full(elemsize) 
#define __RPC__deref_in_xcount_full_opt(elemsize)
#define __RPC__deref_in_xcount_full_string(elemsize)
#define __RPC__deref_in_xcount_full_opt_string(elemsize)
#define __RPC__deref_in_xcount_opt(elemsize) 
#define __RPC__deref_in_xcount_opt_string(elemsize)
#define __RPC__deref_in_xcount_part_opt(elemsize, length) 

// [out]
#define __RPC__out     
#define __RPC__out_ecount(elemsize) 
#define __RPC__out_ecount_part(elemsize, length) 
#define __RPC__out_ecount_full(elemsize)
#define __RPC__out_ecount_full_string(elemsize)
#define __RPC__out_xcount(elemsize) 
#define __RPC__out_xcount_part(elemsize, length) 
#define __RPC__out_xcount_full(elemsize)
#define __RPC__out_xcount_full_string(elemsize)

// [in,out] 
#define __RPC__inout                                   
#define __RPC__inout_string
#define __RPC__opt_inout
#define __RPC__inout_ecount(elemsize)                     
#define __RPC__inout_ecount_part(elemsize, length)    
#define __RPC__inout_ecount_full(elemsize)          
#define __RPC__inout_ecount_full_string(elemsize)          
#define __RPC__inout_xcount(elemsize)                     
#define __RPC__inout_xcount_part(elemsize, length)    
#define __RPC__inout_xcount_full(elemsize)          
#define __RPC__inout_xcount_full_string(elemsize)          

// [in,unique] 
#define __RPC__in_opt       
#define __RPC__in_ecount_opt(elemsize)   
#define __RPC__in_xcount_opt(elemsize)   


// [in,out,unique] 
#define __RPC__inout_opt    
#define __RPC__inout_opt_string    
#define __RPC__inout_ecount_opt(elemsize)  
#define __RPC__inout_ecount_part_opt(elemsize, length) 
#define __RPC__inout_ecount_full_opt(elemsize)     
#define __RPC__inout_ecount_full_string(elemsize)
#define __RPC__inout_xcount_opt(elemsize)  
#define __RPC__inout_xcount_part_opt(elemsize, length) 
#define __RPC__inout_xcount_full_opt(elemsize)     
#define __RPC__inout_xcount_full_string(elemsize)
...
#define __RPC__deref_out_ecount(elemsize) 
#define __RPC__deref_out_ecount_part(elemsize, length) 
#define __RPC__deref_out_ecount_full(elemsize)  
#define __RPC__deref_out_ecount_full_string(elemsize)
#define __RPC__deref_out_xcount(elemsize) 
#define __RPC__deref_out_xcount_part(elemsize, length) 
#define __RPC__deref_out_xcount_full(elemsize)  
#define __RPC__deref_out_xcount_full_string(elemsize)
...
#define __RPC__deref_inout_ecount_full(elemsize)
#define __RPC__deref_inout_ecount_full_string(elemsize)
#define __RPC__deref_inout_ecount_opt(elemsize) 
#define __RPC__deref_inout_ecount_part_opt(elemsize, length) 
#define __RPC__deref_inout_ecount_full_opt(elemsize) 
#define __RPC__deref_inout_ecount_full_opt_string(elemsize) 
#define __RPC__deref_inout_xcount_full(elemsize)
#define __RPC__deref_inout_xcount_full_string(elemsize)
#define __RPC__deref_inout_xcount_opt(elemsize) 
#define __RPC__deref_inout_xcount_part_opt(elemsize, length) 
#define __RPC__deref_inout_xcount_full_opt(elemsize) 
#define __RPC__deref_inout_xcount_full_opt_string(elemsize) 
...
#define __RPC__deref_opt_inout_ecount(elemsize)     
#define __RPC__deref_opt_inout_ecount_part(elemsize, length) 
#define __RPC__deref_opt_inout_ecount_full(elemsize) 
#define __RPC__deref_opt_inout_ecount_full_string(elemsize)
#define __RPC__deref_opt_inout_xcount(elemsize)     
#define __RPC__deref_opt_inout_xcount_part(elemsize, length) 
#define __RPC__deref_opt_inout_xcount_full(elemsize) 
#define __RPC__deref_opt_inout_xcount_full_string(elemsize)

#define __RPC__deref_out_ecount_opt(elemsize) 
#define __RPC__deref_out_ecount_part_opt(elemsize, length) 
#define __RPC__deref_out_ecount_full_opt(elemsize) 
#define __RPC__deref_out_ecount_full_opt_string(elemsize)
#define __RPC__deref_out_xcount_opt(elemsize) 
#define __RPC__deref_out_xcount_part_opt(elemsize, length) 
#define __RPC__deref_out_xcount_full_opt(elemsize) 
#define __RPC__deref_out_xcount_full_opt_string(elemsize)

#define __RPC__deref_opt_inout_opt      
#define __RPC__deref_opt_inout_opt_string
#define __RPC__deref_opt_inout_ecount_opt(elemsize)   
#define __RPC__deref_opt_inout_ecount_part_opt(elemsize, length) 
#define __RPC__deref_opt_inout_ecount_full_opt(elemsize) 
#define __RPC__deref_opt_inout_ecount_full_opt_string(elemsize) 
#define __RPC__deref_opt_inout_xcount_opt(elemsize)   
#define __RPC__deref_opt_inout_xcount_part_opt(elemsize, length) 
#define __RPC__deref_opt_inout_xcount_full_opt(elemsize) 
#define __RPC__deref_opt_inout_xcount_full_opt_string(elemsize) 
