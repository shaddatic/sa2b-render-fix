...
interface D2D1_DECLARE_INTERFACE("2cd90694-12e2-11dc-9fed-001143a055f9") ID2D1RenderTarget  : public ID2D1Resource
{
    ...
    STDMETHOD(CreateLayer)(
        ...
        // pushed.
        //
        __in_opt CONST D2D1_SIZE_F *elemsize,
    ...
    {
        return CreateBitmap(elemsize, srcData, pitch, &bitmapProperties, bitmap);
    }
    ...
    {
        return CreateBitmap(elemsize, NULL, 0, &bitmapProperties, bitmap);
    }
    ...
    {
        return CreateLayer(&elemsize, layer);
    }
...
interface D2D1_DECLARE_INTERFACE("06152247-6f50-465a-9245-118bfd3b6007") ID2D1Factory  : public IUnknown
{
    ...
    {
        return CreateWicBitmapRenderTarget(tgtpos, &renderTargetProperties, renderTarget);
    }
