...
namespace D2D1
{
    ...
    {
        typename TypeTraits<Type>::Size elemsize = { width, height };
    ...
    ArcSegment(
        ...
        __in CONST D2D1_SIZE_F &elemsize,
        __in FLOAT rotationAngle,
        __in D2D1_SWEEP_DIRECTION sweepDirection,
        __in D2D1_ARC_SIZE arcSize
        )
    {
        D2D1_ARC_SEGMENT arcSegment = { point, elemsize, rotationAngle, sweepDirection, arcSize };
    ...
    public:
            ...
            )
        {
            ...
            translation._31 = elemsize.width; translation._32 = elemsize.height;
            ...
            )
        {
            ...
            scale._11 = elemsize.width; scale._12 = 0.0;
            scale._21 = 0.0; scale._22 = elemsize.height;
            scale._31 = center.x - elemsize.width * center.x;
            scale._32 = center.y - elemsize.height * center.y;
