...
#define DoStripFlags    FuncPtr(void, __cdecl, (uint8_t), 0x0042CA20)
...
static RFE_CULLMODE CullOverrideMode;
...
void
RF_SetCullMode(RFE_CULLMODE mode)
{
...
RFG_BackfaceCullingInit()
{
    ...
    */
    ...
    if (RF_ConfigGetInt(CNF_DEBUG_JUMPAURA))
    {
