...
#include <model/e_b_kumi_emblem.nja>
#include <model/e_gold_emblem.nja>
#include <model/e_kyoko_emblem.nja>

#include <model/e_shouko_wing_port.nja>
#include <model/e_shouko_wing_starboard.nja>
#include <model/e_shouko_aft.nja>

#include <model/e_g_pathkumi_emblem.nja>
#include <model/e_b_pathkumi_emblem.nja>
