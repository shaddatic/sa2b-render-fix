...
CHS_CartInit(void)
{
    ...
    RFS_MDLFILE mdl_list[8 * 2] =
    {
        { .puPath = "cart/cart_tails_big_mod.sa2mdl" },
        { .puPath = nullptr },

        { .puPath = "cart/cart_rouge_big_mod.sa2mdl" },
        { .puPath = nullptr },

        { .puPath = "cart/cart_sonic_mod.sa2mdl" },
        { .puPath = "cart/cart_sonic_alt_mod.sa2mdl" },

        { .puPath = "cart/cart_knuckles_mod.sa2mdl" },
        { .puPath = "cart/cart_knuckles_alt_mod.sa2mdl" },

        { .puPath = "cart/cart_tails_mod.sa2mdl" },
        { .puPath = "cart/cart_chao_mod.sa2mdl" },

        { .puPath = "cart/cart_eggman_mod.sa2mdl" },
        { .puPath = "cart/cart_eggman_alt_mod.sa2mdl" },

        { .puPath = "cart/cart_shadow_mod.sa2mdl" },
        { .puPath = "cart/cart_shadow_alt_mod.sa2mdl" },

        { .puPath = "cart/cart_rouge_mod.sa2mdl" },
        { .puPath = "cart/cart_eggrobo_mod.sa2mdl" },
    };
...
#pragma warning(disable : 6011) // annoying warning
    ...
    /** Models **/
    CartObjectList[0][0] = mdl_list[ARY_X2(0, 0)].pObject;
//  CartObjectList[0][1] = mdl_list[ARY_X2(0, 1)].pObject;

    CartObjectList[1][0] = mdl_list[ARY_X2(1, 0)].pObject;
//  CartObjectList[1][1] = mdl_list[ARY_X2(1, 0)].pObject;

    CartObjectList[2][0] = mdl_list[ARY_X2(2, 0)].pObject;
    CartObjectList[2][1] = mdl_list[ARY_X2(2, 1)].pObject;

    CartObjectList[3][0] = mdl_list[ARY_X2(3, 0)].pObject;
    CartObjectList[3][1] = mdl_list[ARY_X2(3, 1)].pObject;

    CartObjectList[4][0] = mdl_list[ARY_X2(4, 0)].pObject;
    CartObjectList[4][1] = mdl_list[ARY_X2(4, 1)].pObject;

    CartObjectList[5][0] = mdl_list[ARY_X2(5, 0)].pObject;
    CartObjectList[5][1] = mdl_list[ARY_X2(5, 1)].pObject;

    CartObjectList[6][0] = mdl_list[ARY_X2(6, 0)].pObject;
    CartObjectList[6][1] = mdl_list[ARY_X2(6, 1)].pObject;

    CartObjectList[7][0] = mdl_list[ARY_X2(7, 0)].pObject;
    CartObjectList[7][1] = mdl_list[ARY_X2(7, 1)].pObject;
